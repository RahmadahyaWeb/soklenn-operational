...
{!! json_encode([
    ...
    'address' => [
        '@type' => 'PostalAddress',
        'streetAddress' => 'Jalan Ambulung, Kemuning, Kec. Banjarbaru Selatan, Kota Banjar Baru, Kalimantan Selatan 70714',
    ...
    <section class="py-20 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center mb-14">
                ...
                <div class="inline-flex rounded-full bg-[#0b3d2c]/10 px-4 py-2 text-sm font-bold text-[#0b3d2c]">
                    TESTIMONI
                </div>
                ...
                <p class="mt-4 max-w-2xl mx-auto text-zinc-600">
                    Kepuasan pelanggan adalah prioritas utama kami. Berikut beberapa pengalaman mereka setelah
                    menggunakan layanan Soklenn.
                </p>
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-12">
                ...
                <div class="rounded-3xl bg-[#0b3d2c] p-8 text-white text-center">
                ...
                <div class="rounded-3xl border border-zinc-200 p-8 text-center">

                    <div class="text-5xl font-black text-[#0b3d2c]">
                        1K+
                    </div>

                    <div class="mt-2 text-zinc-600">
                        Sepatu Telah Dibersihkan
                    </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="rounded-3xl border border-zinc-200 p-7 hover:shadow-xl transition duration-300">
                    ...
                    <p class="text-zinc-600 leading-relaxed">
                        Sepatu running saya yang tadinya kusam jadi kelihatan seperti baru lagi. Hasil cleaning-nya
                        detail sampai ke bagian sol.
                    </p>
                ...
                <div class="rounded-3xl border border-zinc-200 p-7 hover:shadow-xl transition duration-300">
                    ...
                    <p class="text-zinc-600 leading-relaxed">
                        Pelayanannya ramah dan prosesnya cepat. Sangat terbantu karena ada layanan pick up dan delivery.
                    </p>
                ...
                <div class="rounded-3xl border border-zinc-200 p-7 hover:shadow-xl transition duration-300">
                    ...
                    <p class="text-zinc-600 leading-relaxed">
                        Sepatu putih yang sudah menguning jadi jauh lebih bersih. Hasilnya melebihi ekspektasi saya.
                    </p>
                ...
                <div class="rounded-3xl border border-zinc-200 p-7 hover:shadow-xl transition duration-300">
                    ...
                    <p class="text-zinc-600 leading-relaxed">
                        Sepatu kerja saya kembali bersih dan nyaman dipakai. Proses pengerjaannya juga sesuai estimasi.
                    </p>
                ...
                <div class="rounded-3xl border border-zinc-200 p-7 hover:shadow-xl transition duration-300">
                    ...
                    <p class="text-zinc-600 leading-relaxed">
                        Sudah beberapa kali cuci di Soklenn dan hasilnya selalu konsisten. Recommended untuk yang suka
                        sneakers.
                    </p>
                ...
                <div class="rounded-3xl border border-zinc-200 p-7 hover:shadow-xl transition duration-300">
                    ...
                    <p class="text-zinc-600 leading-relaxed">
                        Komunikasi jelas, pengerjaan rapi, dan hasilnya memuaskan. Sepatu favorit saya jadi fresh lagi.
                    </p>
    ...
    <section class="py-20 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="text-center mb-12">
                ...
                <h2 class="mt-4 text-4xl md:text-5xl font-black">
                    Kunjungi Soklenn
                </h2>

                <p class="mt-4 text-zinc-600 max-w-2xl mx-auto">
                    Melayani jasa cuci sepatu profesional di Banjarbaru dengan layanan antar jemput untuk area tertentu.
                </p>
            ...
            <div class="grid lg:grid-cols-2 gap-8">
                ...
                <div class="rounded-3xl border border-zinc-200 p-8">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="text-zinc-600">
                                Jalan Ambulung, Kemuning, Kec. Banjarbaru Selatan, Kota Banjar Baru, Kalimantan Selatan
                                70714
                            </div>
                        </div>
                ...
                <div class="overflow-hidden rounded-3xl border border-zinc-200">

                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1806.8092180794945!2d114.8246995937825!3d-3.45714393532648!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de681325ddf4611%3A0x268eca23170a43b7!2sSoklenn%20Cuci%20Sepatu%20Banjarbaru!5e0!3m2!1sid!2sid!4v1782117586123!5m2!1sid!2sid"
    ...
    <section class="py-20 bg-gradient-to-b from-white to-zinc-50">
        <div class="max-w-5xl mx-auto px-4">
            ...
            <div class="space-y-4">
                ...
                <details
                    class="group rounded-3xl bg-white border border-zinc-200 overflow-hidden hover:shadow-lg transition duration-300">
                    <summary class="list-none cursor-pointer p-6">
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <span
                                class="text-2xl font-light text-[#0b3d2c] transition-transform duration-300 group-open:rotate-45">
                                +
                            </span>
                        </div>
                    </summary>
                ...
                <details
                    ...
                    <summary class="list-none cursor-pointer p-6">
                        <div class="flex items-center justify-between gap-4">
                            <h3 class="font-bold text-lg text-zinc-900">
                                Berapa harga layanan Deep Clean?
                            </h3>
                ...
                <details
                    ...
                    <summary class="list-none cursor-pointer p-6">
                        <div class="flex items-center justify-between gap-4">
                            <h3 class="font-bold text-lg text-zinc-900">
                                Apakah sepatu putih yang menguning bisa dibersihkan?
                            </h3>
