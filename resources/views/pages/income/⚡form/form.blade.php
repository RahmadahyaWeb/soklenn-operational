<div class="space-y-6">
    ...
    <x-page-header :title="$income ? 'Edit Income' : 'Create Income'" :description="$income ? 'Update income transaction information.' : 'Create a new manual income transaction.'" />
        ...
        <flux:card class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <flux:field>
                    ...
                    <flux:select wire:model="income_category_id">
                    ...
                    <flux:error name="income_category_id" />
                </flux:field>
