{{-- HEADER --}}
<header class="sticky top-0 z-50 bg-[#0b3d2c]/95 backdrop-blur border-b border-white/10">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-5">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-10 text-white font-medium">
                ...
                <a href="#testimonials" class="hover:opacity-70 transition">
                    Testimonials
                </a>
                ...
                <a href="{{ route('membership.lookup') }}" class="hover:opacity-70 transition">
                    Membership
                </a>
